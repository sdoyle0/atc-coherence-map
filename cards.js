...
class Domain extends React.Component {
  ...
  render() {
    ...
    var gradeMap = {"KY.K": "Kindergarten", "KY.1": "1st Grade", "KY.2": "2nd Grade", "KY.3": "3rd Grade",
                    "KY.4": "4th Grade", "KY.5": "5th Grade", "KY.6": "6th Grade"/*, 2: "2nd Grade", 3: "3rd Grade", 4: "4th Grade", 5: "5th Grade", 6: "6th Grade", 7: "7th Grade",
...
export class Deck extends React.Component {x
  ...
  render() {
    ...
    return <div className='deck'>
      ...
      {
        ['KY.K',"KY.1","KY.2","KY.3","KY.4","KY.5","KY.6"].map((g, i) =>
